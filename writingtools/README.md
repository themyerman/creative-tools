...
Ten built-in voices control how prompts are written. Edit or add your own:
...
Options:
  ...
  --voice TEXT         Voice style: neutral, trailer, bestseller, xfiles,
                       trashy, campfire, kenburns, pulp, academic, satiric,
                       or 'random' (default)
